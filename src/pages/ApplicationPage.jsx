        ...
        <div className="flex-1">
          ...
          <div className="mt-3 flex flex-wrap gap-6 md:gap-20">
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-sm md:text-base text-gray-500 font-semibold mt-2">Downloads</h2>
              <h1 className="text-2xl md:text-3xl font-bold mt-1">{app.downloads}</h1>
            </div>

            <div className="flex flex-col items-center">
              <Star size={30} strokeWidth={3} className="text-orange-300" />
              <h2 className="text-sm md:text-base text-gray-500 font-semibold mt-2">Average Ratings</h2>
              <h1 className="text-2xl md:text-3xl font-bold mt-1">{app.ratingAvg}</h1>
            </div>

            <div className="flex flex-col items-center">
              <ThumbsUp size={30} strokeWidth={3} className="text-purple-500" />
              <h2 className="text-sm md:text-base text-gray-500 font-semibold mt-2">Total Reviews</h2>
              <h1 className="text-2xl md:text-3xl font-bold mt-1">{app.reviews}</h1>
            </div>
          </div>
